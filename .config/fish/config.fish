...
switch (uname)
  case Darwin
    ...
    fish_add_path /opt/homebrew/Cellar/postgresql@15/15.5_1/bin
  # alias firefox="open"
  case Linux
    # set -x GOPATH $HOME/.go-nix
    # set -x GOROOT /usr/lib/go-1.18
    # set PATH $GOPATH/bin $HOME/.local/bin $HOME/.config/gopass $HOME/.rbenv/bin $PATH
...
if [ -f '/Users/daryl/Downloads/google-cloud-sdk/path.fish.inc' ]; . '/Users/daryl/Downloads/google-cloud-sdk/path.fish.inc'; end
